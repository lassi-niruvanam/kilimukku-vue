...
import { கிளிமூக்கை_உருவாக்கு } from "./கிளிமூக்கு.js";
...
export default ({
  ...
  விண்மீன்_சொத்து?: string;
}) => {
  return {
    install: (செயலி: App) => {
      const விண்மீன் = செயலி.config.globalProperties[விண்மீன்_சொத்து];
