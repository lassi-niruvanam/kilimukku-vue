    ...
    return computed(() => {
      ...
      if (!செய்தி_அகராதி) {
        if (!மொழிபெயரப்பில்லாத_சாபிகள்.value.includes(சாபி)) {
          மொழிபெயரப்பில்லாத_சாபிகள்.value = [...மொழிபெயரப்பில்லாத_சாபிகள்.value, சாபி]
        }
        return சாபி
      };
      ...
      const செய்தியை_வடிவூட்டு = (
        ...
        செய்தி = செய்தி.replaceAll(தொடர்பு_சுருங்புறித்தொடர், function (_, இணைப்பு_சாபி) {
          const இணைப்பு_சாபி_பிடித்த_கிடைக்ககூடிய_மொழி = அனைத்த_சாத்தியமான_மொழிகள்.value.find(
            (மொ) => !!செய்தி_அகராதி[இணைப்பு_சாபி]?.[மொ],
          );
          const இறுதியான_செய்தி = இணைப்பு_சாபி_பிடித்த_கிடைக்ககூடிய_மொழி
            ? செய்தி_அகராதி[இணைப்பு_சாபி][இணைப்பு_சாபி_பிடித்த_கிடைக்ககூடிய_மொழி]
            : இணைப்பு_சாபி;
...
const சாபிகளை_பயன்படுத்து = ({ கிளி }: { கிளி?: கிளிமூக்கு } = {}) => {
  ...
  const சாபிகள் = computed(()=>{
    return [...new Set([...மொழிபெயரப்பில்லாத_சாபிகள்.value, ...மொழிபெயர்ப்புடன்_சாபிகள்.value])]
  })
