...
import type { Ref, App, ComputedRef, MaybeRef } from "vue";
...
export const செய்திகளைப்_பயன்படுத்து = ({
  பரிந்துரைகள் = "எனது",
  கிளி,
}: {
  பரிந்துரைகள்?: "எனது" | "எல்லாம்" | "வேண்டாம்";
...
export const மொழியாக்கத்தைப்_பயன்படுத்து = (
  {
    பரிந்துரைகள் = "எனது",
    கிளி,
  }: {
  ...
  const { கிடைக்கும்_மொழி_குறியீடுகள்: கிளிமூக்கு_மொழிகள் } =
    கிடைக்கும்_மொழிகளைப்_பயன்படுத்து({ பரிந்துரைகள், கிளி });
  ...
  const மொ = (
    ...
    return computed(() => {
      ...
      const வடிவூட்டு = <T>(மதிப்பு: MaybeRef<T>): string | T | undefined => {
        const மதிப்பின்_மதிப்பு = unref(மதிப்பு)
        if (typeof மதிப்பின்_மதிப்பு === "number") {
          return எண்ணை_வடிவூட்டு(மதிப்பின்_மதிப்பு).value;
        }
        return மதிப்பின்_மதிப்பு;
      };
...
export const கிடைக்கும்_மொழிகளைப்_பயன்படுத்து = (
  {
    பரிந்துரைகள்,
    கிளி,
  }: {
...
export const மொழி_முன்னேற்றத்தைப்_பயன்படுத்து = ({
  மொழி,
  வகை = "வார்த்தை",
  கிளி,
}: {
...
export const சாபிகளைப்_பயன்படுத்து = ({ கிளி }: { கிளி?: கிளிமூக்கு } = {}) => {
  const நம்ம_கிளி = கிளி || கிளியை_கண்டுப்பிடி();

  const { மொழிபெயரப்பில்லாத_சாபிகள் } = மொழியாக்கத்தைப்_பயன்படுத்து();
...
export const மொழிபெயர்ப்புகளைப்_பயன்படுத்து = ({
  கிளி,
}: {
  கிளி?: கிளிமூக்கு;
} = {}): {
...
export const பரிந்துரைகளைப்_பயன்படுத்து = ({
  கிளி,
}: {
  கிளி?: கிளிமூக்கு;
} = {}): {
