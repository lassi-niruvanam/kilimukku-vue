...
class சேமிக்கப்பட்ட_செய்திகள் {
  ...
  அடையாளமத்தைப்_பெறு({
    ...
    const கிளி_அடையாளம் = கிளி.குழு_அடையாளம் + கிளி.அட்டவணை_சாபி;
    return {
      கிளி_அடையாளம்,
      விருப்பங்களின்_அடையாளம்: கிளி_அடையாளம் + பரிந்துரைகள்,
    };
  }
  ...
  கேள்ளு({
    ...
    if (!this.செய்திகள்[கிளி_அடையாளம்].விருப்பங்கள்[விருப்பங்களின்_அடையாளம்]) {
      ...
      கிளி
        ...
        .then(
          (மறந்துவிடு) =>
            (this.செய்திகள்[கிளி_அடையாளம்].விருப்பங்கள்[
              விருப்பங்களின்_அடையாளம்
...
const செய்திகளைப்_பயன்படுத்து = ({
  ...
  const { செய்திகள், அடையாளம் } = மேலாளர்.கேள்ளு({
    கிளி,
    பரிந்துரைகள்,
  });
